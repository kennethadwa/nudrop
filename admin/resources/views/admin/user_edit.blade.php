        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white p-6 shadow-lg sm:rounded-lg flex flex-col items-center">
                ...
                <div class="flex flex-col items-center mb-8">
                    <div class="relative">
                        <!-- Profile Picture -->
                        <img id="profileImage" src="{{ asset('storage/' . $user->profile_picture) ?? 'https://via.placeholder.com/150' }}" alt="Profile"
                            class="h-32 w-32 rounded-full object-cover border-4 border-blue-600">

                        <!-- Edit Profile Picture Button -->
                        <label for="profile_picture" class="absolute bottom-0 right-0 bg-blue-500 text-white p-2 rounded-full cursor-pointer hover:bg-blue-600">

        ...
        <div class="max-w-9xl mx-auto sm:px-6 lg:px-12 xl:px-16">
            <div class="overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <div class="mb-6 flex justify-between">
                    <h1 class="text-xl font-semibold text-gray-800">Registrar Office Account</h1>
                    <a href="{{ route('registrar.staff.create') }}"
                        ...
                        @foreach ($staff as $staff)
                            <tr>
                                ...
                                <td class="flex space-x-2 px-4 py-2">
                                    <a href="{{ route('registrar.staff.edit', $staff->id) }}"
                                    ...
                                    <form action="{{ route('registrar.staff.destroy', $staff->id) }}" method="POST"
